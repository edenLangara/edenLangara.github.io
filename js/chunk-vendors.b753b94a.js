 ...
 * limitations under the License.
 */
class Be{constructor(e,t){this._service=e,this._location=t instanceof x?t:x.makeFromUrl(t,e.host)}toString(){return"gs://"+this._location.bucket+"/"+this._location.path}_newRef(e,t){return new Be(e,t)}get root(){const e=new x(this._location.bucket,"");return this._newRef(this._service,e)}get bucket(){return this._location.bucket}get fullPath(){return this._location.path}get name(){return me(this._location.path)}get storage(){return this._service}get parent(){const e=pe(this._location.path);if(null===e)return null;const t=new x(this._location.bucket,e);return new Be(this._service,t)}_throwIfRoot(e){if(""===this._location.path)throw A(e)}}function qe(e,t,n){e._throwIfRoot("uploadBytes");const r=Me(e.storage,e._location,_e(),new de(t,!0),n);return e.storage.makeRequestWithTokens(r,Ve).then((t=>({metadata:t,ref:e})))}function $e(e){e._throwIfRoot("getDownloadURL");const t=Ne(e.storage,e._location,_e());return e.storage.makeRequestWithTokens(t,Ve).then((e=>{if(null===e)throw T();return e}))}function ze(e,t){const n=ge(e._location.path,t),r=new x(e._location.bucket,n);return new Be(e.storage,r)}
/**
 * @license
 * Copyright 2017 Google LLC
 *
